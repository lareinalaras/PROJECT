...
export default function List() {
    ...
    return (
        <Sidebar>
            ...
            <NavLink to="/dashboard/list-job-vacancy/create" className="py-2 px-10 my-5 rounded-md bg-purple-600 text-white">Create Job</NavLink>
            <br />
            <br />
                                ...
                                return (
                                    <tr key={job.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <td className='align-middle table-cell'>
                                            <NavLink to={`/dashboard/list-job-vacancy/edit/${job.id}`} className="p-2 mr-5 rounded-md bg-purple-200 text-white">Edit</NavLink>
